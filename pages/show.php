...
<body>
    <div class="container-fluid">
        <div id="head-margin">
            <h1 id="top-header">Personal Steam Statistics: <br> Show Prior Steam Data</h1>
        </div>
        <!-- Bootstrap Nav -->
        ...
        <div id="show-content-container">
            ...
            <form action="show-result.php" method="POST">
                ...
                <br>
                <div style="width: 100%; text-align: center; left: 50%;">
                    <p style="text-align: center;">Note: This will retrieve data from the database.<br> See "Help" page for more info.</p>
                </div>
            </form>
        </div>
    </div>
